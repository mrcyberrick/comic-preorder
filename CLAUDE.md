...
**Last completed work: F99 S3-B — Brevo transactional EVALUATED and REJECTED; direction set to
Resend, 2026-09-02.** Doc-only session (`1610328`, staging). No code, no DNS, no MailerSend change —
**production untouched throughout, and there is nothing to roll back.** Both of Rick's alternatives
to the failed S3 attempt were explored and closed on evidence.
