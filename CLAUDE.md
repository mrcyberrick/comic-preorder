...
- **Order-invoice reconciliation (F108)** — ingest the distributor order
  ...
  F101/F102 session by Rick 2026-08-02. See `docs/technical-reference.md`
  § 13 F108.
