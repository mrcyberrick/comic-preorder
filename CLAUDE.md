...
| F132 | **Medium** — a PRH title restricted to a distributor allocation ratio (e.g. `1:10`, 15% of PRH titles) carries no signal at reservation time; customer only learns via the retrospective F117/F120 rejected badge | Owner: `docs/order-restriction-alert-badge.md` (staging V1-V4 GREEN 2026-08-20 — migration applied, badge real-browser-verified via Playwright, 198/198 unit tests. **Only V5 left: a real Sept ~7-10 PRH import spot-check.** Production not requested) |
