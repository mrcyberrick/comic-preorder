...
- [ ] ⚠️ **V2, V4 and V10 still open.** V10 (a committed spec) is the one that matters: the harness above is local-only and untracked, so nothing in CI defends this behaviour
