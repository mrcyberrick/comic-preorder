...
- **The correct action today exists but is four navigations away** — Ordering ▸ By Distributor ▸ find the title ▸ Mark Ordered ▸ *Adjustment (correction)* ▸ negative quantity. Correct, and deliberately still available on a closed cycle (2026-08-06 decision). The defect is that the quick, wrong action sits in front of the operator and the right one does not.
