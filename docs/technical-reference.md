...
- **Status:** filed 2026-08-05, the moment a real correction was made and found unrecordable. **Open — folded into Session B of `docs/order-loop-closure-f108.md`**, which was already relaxing the same CHECK constraint for a different reason. Not a separate session.
...
- **Status:** filed and **RESOLVED 2026-08-06, same session** — found by Rick reviewing staging during the order-loop-closure Session B deploy, fixed same session, live on staging (comic-preorder `0f33900`). Production promotion is bundled with the rest of Session B's client changes — Rick's call, not yet requested.
...
- **Status:** filed and **RESOLVED 2026-08-06, same session** — found by Rick reviewing staging immediately after F118, fixed same session, live on staging (`307b5ab`). Production promotion is bundled with the rest of the session's client changes — Rick's call, not yet requested.
...
- **Status:** filed and **RESOLVED 2026-08-06, same session** — found by Rick reviewing the F119 fix on staging ("a rejected title was shown as arriving for the scheduled week"), fixed same session, live on staging (`56da34c`). Production promotion is bundled with the rest of the session's client changes — Rick's call, not yet requested.
