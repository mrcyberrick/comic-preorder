...
- **Status:** filed 2026-08-21, surfaced by Rick on the first production run of the F115 panel — five rows appeared and none could be cleared. **Open — plan: `docs/f134-arrival-resolution.md`.** Part 1 (the exits) is a one-line fix and can ship alone; Part 2 (manual resolution) carries a schema change and a customer-facing surface.
