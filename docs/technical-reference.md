...
- **This is a PRODUCT decision, not an engineering one, and it is the one thing owed:** should deleting an auth user **erase** that person's archived reservation history, or **preserve it de-identified**?
