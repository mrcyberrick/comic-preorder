...
- `order_requirement` — **both distributors** (corrected 2026-08-20, same
  ...
  **Live on staging 2026-08-20, 0 non-null rows** — populates naturally on
  the next import — moved up to **2026-08-21** (Rick), pending confirmation
  it includes the catalog-refresh step — for both distributors, no backfill planned.
