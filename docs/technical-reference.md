...
- **Status:** filed 2026-08-20 during the scoping session for `docs/order-restriction-alert-badge.md`. **STAGING COMPLETE 2026-08-21 — production not requested.** Filed at Rick's request (two asks: alert restricted titles, badge restricted/incentive variants with a "Learn more" disclosure).
...
- **Only production remains, not requested.** Full runbook + gate detail: `docs/order-restriction-alert-badge.md` § 7–9.
