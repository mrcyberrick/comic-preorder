...
§ 5.7.6). **Session 4 (the mode switch) is LIVE IN PRODUCTION 2026-08-08** (PR #110, merge `de0d7ca`) — the dashboard is now three modes on three cadences, not a tab strip. **Session 5a (publisher grouping, search, mobile scroll) is LIVE IN PRODUCTION 2026-08-08** (PR #111, merge `f031916`). **Session 5b (cross-month search) is LIVE IN PRODUCTION 2026-08-09** (PR #113, merge `d12921e`). **Session 6 (Ordering mode + the Paper Orders split) in execution 2026-08-09** — `docs/admin-restructure-6-ordering-mode.md`. Remaining decisions in § 6.
